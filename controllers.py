...
def home():
    ...
    return render_template('home.html',show_block=True,show_nav=True,show_nav2=True,books=all_books)
...
def product():
    ...
    return render_template('product.html',show_block=False,show_nav=False,show_nav2=False,name=book_name,price=book_price,all_comments = all_comments,old_price=book_old_price,description=book_description,image=book_image_path,quantity=book_quantity,language=book_language,genre=book_genre,author=book_author,published_at=book_published_at, form = form)
